<?php
	...
	if (isset($_GET['id']) && isset($_POST['submit'])) {
		...
		setMessage("Image delete sucessfully.  The file must be removed by hand", "good");
		...
		$query = "SELECT name, image FROM images WHERE imageid = $imageid";
		$result = mysql_query($query);
...
?>
<html>
<head><title>Eipen - Delete Image</title>
...
<?php
	...
	if (mysql_num_rows($result) == 0 ) {
		...
		while($row = mysql_fetch_array($result)) {
			...
			print "<li>$name <div id=\"status_right\"><div id=\"status_box\"><a href=\"deleteimage.php?id=$imageid\">".
